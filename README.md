...
| <a name="input_registration_account_id"></a> [registration\_account\_id](#input\_registration\_account\_id) | Registration account ID for Avi Cloud Services | `string` | `null` | no |
| <a name="input_registration_email"></a> [registration\_email](#input\_registration\_email) | Registration email address for Avi Cloud Services | `string` | `null` | no |
| <a name="input_registration_jwt"></a> [registration\_jwt](#input\_registration\_jwt) | Registration JWT Token for Avi Cloud Services | `string` | `null` | no |
