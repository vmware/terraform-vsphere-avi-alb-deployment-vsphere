...
| <a name="input_cluster_ip"></a> [cluster\_ip](#input\_cluster\_ip) | Optional sets the IP address of the Avi Controller cluster. This address must be in the same subnet as the Avi Controller VMs. | `string` | `null` | no |
